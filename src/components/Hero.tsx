...
const Hero = () => {
  ...
  return (
    <section 
      id="hero" 
      className="min-h-screen flex items-center pt-16 pb-12 dark:bg-slate-800"
    >
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 dark:from-blue-500/10 dark:to-cyan-500/10 rounded-full blur-2xl"></div>
              <div className="relative overflow-hidden rounded-full border-4 border-white dark:border-slate-700 shadow-xl w-64 h-64 md:w-80 md:h-80">
                <img 
          ...
          >
            ...
            <h2 className="text-xl md:text-2xl text-slate-700 dark:text-slate-300 mb-6">Aspiring Software Developer</h2>
            
            <div className="flex flex-col gap-3 mb-8 text-slate-600 dark:text-slate-400">
            ...
            <div className="flex flex-wrap gap-4">
              <Button onClick={scrollToContact} className="bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600">
                Contact Me
              </Button>
              <Button variant="outline" className="group dark:border-slate-700 dark:text-white dark:hover:bg-slate-700" onClick={() => {
